...
&nbsp;&nbsp;&nbsp;&nbsp;<a href="#tth_sEc4.3"
>4.3&nbsp; The Main gdb Commands</a><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#tth_sEc4.3.1"
...
# 补充
1. `set disassemble-next-line on` 提示即将执行的汇编代码

2. `set logging on`  记录gdb

3. gdb中的display不仅可以对变量,还可以对内存检查指令**x**
   例如,`disp /4b mem_brk-0x800-0x04`在malloclab中显示指定内存位置的值, 每块1个字节,连续显示4块,其实和指令`x`一样
